...
function money(montant) {
    ...
    if (montant === 1 || montant === 3) {
        console.log(`le montant insérer ne peut pas etre rendu avec les valeurs billets et pieces que nous possedons`); 
    }
    else if (montant === 2) {
       ...
       console.log('nbDeBillet10: ', nbDeBillet10)
        ...
        if (modulo10>=5) {
            ...
            if(modulo5%2==0 && rest_a_ModulerPar2__ouPas > 1) {
               ...
               console.log(`le montant insérer ne pas etre rendu avec les valeurs billets et pieces que nous possedons`); 
            }
        }

    }
    return console.log(`definir un return`)
}
// money(7);
